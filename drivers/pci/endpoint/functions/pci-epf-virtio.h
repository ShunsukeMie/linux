...
struct epf_virtio {
	 ...
	 * Note: Because of the hardware limitation, PCI EP function cannot
	 * detect qnotify accurately, therefore this callback function should
	 * check all of virtqueue's changes.
	 */
